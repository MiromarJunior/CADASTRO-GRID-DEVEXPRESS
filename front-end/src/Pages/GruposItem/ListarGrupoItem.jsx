...
const ListarGrupoItem = () => {
  ...
  const acessoSGRA = (valor) => {
    return (
      <Button
        variant="outlined"
        size="small"
        onClick={(e) => navigate(`/ListarSubGrupoItem/${valor}`)}
      >
        SubGrupo
      </Button>
    );
  ...
  const EditSubGrupo = ({ value }) => acessoSGRA(value);
  const EditSubGrupoProv = (props) => (
    <DataTypeProvider formatterComponent={EditSubGrupo} {...props} />
  );
      ...
      <div className="container">
        <Paper>
          <Grid rows={rows} columns={columns}>
            ...
            />
            <EditSubGrupoProv for={editSubGrupo} />
            <Table />
