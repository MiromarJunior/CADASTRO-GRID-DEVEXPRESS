...
const buscarContatos =(idSeguradora)=>{    
...
const buscarSeguradoras =()=>{
    ...
    const salvarSeguradora = (newRecord) => {
        ...
        const dados = {            
            ...
            soapRetSol, soapRetNotas,token,idSeg,newRecord
...
console.log(dados);
    ...
    const salvarContato = (rows)=>{
        const dadosContato = {contatos : rows, token, idSeg : idSeguradora}
